 var EventEnum = {
  ...
  properties: {
    ...
    "DRIVER_IDENTIFICATION_ON": {icon: "driver_identification_on_info_40.png", description: "Identificación del conductor activada"},
    "DRIVER_IDENTIFICATION_OFF": {icon: "driver_identification_off_info_40.png", description: "Identificación del conductor desactivada"},
